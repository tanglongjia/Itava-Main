    ...
    BootstrapTable.prototype.initToolbar = function () {
                ...
                if(cvalue !=null && cvalue!=''){
                    ...
                    if(arr.length > 0){
                    	for(var i = 0 ; i < arr.length ; i++){
                    		 ...
                    		 if(arry[0]!=null &&  arry[0]!='' && arry[0] == column.field){
                    			 var checked ='';
                    			 that.toggleColumn(column.field, false, false);
                    			 break;
                    		 }
                    	}
                    }
        ...
        if (this.options.showColumns) {
            ...
            $keepOpen.find('input').off('click').on('click', function () {
                ...
                //向cookie中写数据 
                var value=$(this).data('field')+'|'+$this.prop('checked');
                if($this.prop('checked')){//选中
                	//1、先用 带逗号的替换 中间的都带逗号
                	cvalue = cvalue.replace($(this).data('field')+"|false,","");
                	//2、再用不带逗号的替换 最后一个是不带逗号的
                	cvalue = cvalue.replace($(this).data('field')+"|false","");
                	value = cvalue;
                }else{//未选中
                	if(cvalue != null && cvalue != ''){
