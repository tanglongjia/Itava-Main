...
public final class userInit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path;
      ...
      out.write("\t\t\t\t\t<button type=\"button\" class=\"btn btn-info pull-right\" style=\"margin-left: 3px;\"  id=\"add\">新增</button>\r\n");
      ...
      out.write("\t\t$('#querylist').bootstrapTable('destroy').bootstrapTable({\r\n");
      out.write("            //请求方法\r\n");
