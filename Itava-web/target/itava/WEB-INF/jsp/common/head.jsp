...
<!-- 扩展的js方法 -->
<script type="text/javascript" src="<%=basePath%>/commonjs/bootstrap_extra.js"></script>
<!-- ueditor需要的js文件 -->
<script type="text/javascript" src="<%=basePath%>/aframe/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="<%=basePath%>/aframe/ueditor/ueditor.all.js"></script>
